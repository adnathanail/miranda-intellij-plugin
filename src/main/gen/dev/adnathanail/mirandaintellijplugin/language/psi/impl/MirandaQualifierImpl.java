...
public class MirandaQualifierImpl extends ASTWrapperPsiElement implements MirandaQualifier {

  public MirandaQualifierImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public MirandaGenerator getGenerator() {
    return findChildByClass(MirandaGenerator.class);
  }
