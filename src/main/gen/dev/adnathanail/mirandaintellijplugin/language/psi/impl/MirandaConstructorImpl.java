...
public class MirandaConstructorImpl extends ASTWrapperPsiElement implements MirandaConstructor {

  public MirandaConstructorImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public PsiElement getIdentifierUpper() {
    return findNotNullChildByType(IDENTIFIER_UPPER);
  }
