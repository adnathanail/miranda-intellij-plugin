...
public class MirandaWhdefsImpl extends ASTWrapperPsiElement implements MirandaWhdefs {

  public MirandaWhdefsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MirandaVisitor visitor) {
    visitor.visitWhdefs(this);
  }
  ...
  @Override
  @NotNull
  public List<MirandaDef> getDefList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, MirandaDef.class);
  }
