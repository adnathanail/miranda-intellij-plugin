...
public class MirandaExpImpl extends ASTWrapperPsiElement implements MirandaExp {

  public MirandaExpImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public MirandaPrefix1 getPrefix1() {
    return findChildByClass(MirandaPrefix1.class);
  }
