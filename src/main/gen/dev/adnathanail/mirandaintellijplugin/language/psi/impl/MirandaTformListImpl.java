...
public class MirandaTformListImpl extends ASTWrapperPsiElement implements MirandaTformList {

  public MirandaTformListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MirandaVisitor visitor) {
    visitor.visitTformList(this);
  }
