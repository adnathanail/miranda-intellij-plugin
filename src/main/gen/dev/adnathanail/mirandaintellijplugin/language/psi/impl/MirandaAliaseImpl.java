...
public class MirandaAliaseImpl extends ASTWrapperPsiElement implements MirandaAliase {

  public MirandaAliaseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MirandaVisitor visitor) {
    visitor.visitAliase(this);
  }
