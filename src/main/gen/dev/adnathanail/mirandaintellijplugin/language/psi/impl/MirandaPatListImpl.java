...
public class MirandaPatListImpl extends ASTWrapperPsiElement implements MirandaPatList {

  public MirandaPatListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MirandaVisitor visitor) {
    visitor.visitPatList(this);
  }
