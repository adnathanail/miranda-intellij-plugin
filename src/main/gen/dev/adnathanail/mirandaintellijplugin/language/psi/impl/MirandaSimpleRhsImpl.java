...
public class MirandaSimpleRhsImpl extends ASTWrapperPsiElement implements MirandaSimpleRhs {

  public MirandaSimpleRhsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MirandaVisitor visitor) {
    visitor.visitSimpleRhs(this);
  }
  ...
  public MirandaExp getExp() {
    return findNotNullChildByClass(MirandaExp.class);
  }
