...
public class MirandaPartsImpl extends ASTWrapperPsiElement implements MirandaParts {

  public MirandaPartsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MirandaVisitor visitor) {
    visitor.visitParts(this);
  }
  ...
  @Override
  @NotNull
  public List<MirandaPart> getPartList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, MirandaPart.class);
  }
