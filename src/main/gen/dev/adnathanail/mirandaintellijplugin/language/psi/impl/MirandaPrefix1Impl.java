...
public class MirandaPrefix1Impl extends ASTWrapperPsiElement implements MirandaPrefix1 {

  public MirandaPrefix1Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MirandaVisitor visitor) {
    visitor.visitPrefix1(this);
  }
