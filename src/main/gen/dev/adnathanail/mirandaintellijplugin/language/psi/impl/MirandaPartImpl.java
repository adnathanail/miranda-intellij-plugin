...
public class MirandaPartImpl extends ASTWrapperPsiElement implements MirandaPart {

  public MirandaPartImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PsiElement getIdentifierLower() {
    return findChildByType(IDENTIFIER_LOWER);
  }

  @Override
  @Nullable
  public PsiElement getPathname() {
    return findChildByType(PATHNAME);
  }
