...
public class MirandaLastaltImpl extends ASTWrapperPsiElement implements MirandaLastalt {

  public MirandaLastaltImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MirandaVisitor visitor) {
    visitor.visitLastalt(this);
  }
