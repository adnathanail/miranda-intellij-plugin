...
public class MirandaE1SimpleImpl extends MirandaE1Impl implements MirandaE1Simple {

  public MirandaE1SimpleImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull MirandaVisitor visitor) {
    visitor.visitE1Simple(this);
  }
  ...
  @Override
  @NotNull
  public List<MirandaSimple> getSimpleList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, MirandaSimple.class);
  }
