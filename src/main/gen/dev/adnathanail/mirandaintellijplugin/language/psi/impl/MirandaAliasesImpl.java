...
public class MirandaAliasesImpl extends ASTWrapperPsiElement implements MirandaAliases {

  public MirandaAliasesImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MirandaVisitor visitor) {
    visitor.visitAliases(this);
  }
  ...
  @Override
  @NotNull
  public List<MirandaAliase> getAliaseList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, MirandaAliase.class);
  }
